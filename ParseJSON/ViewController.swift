...
class ViewController: UIViewController {
    ...
    func  parseJson() {
        ...
        var parseData = JSON(data: jsonData, options: JSONSerialization.ReadingOptions.mutableContainers, error: nil)
        ...
        // Delete Value
        parseData.dictionaryObject?.removeValue(forKey: "seq")
        print("parse Data \(parseData)")
